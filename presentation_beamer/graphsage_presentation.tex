...
\begin{frame}{System Architecture Overview}
    ...
    \begin{itemize}
        ...
        \item \textbf{Network} InfiniBand + NVLink
...
\begin{frame}{Tunable Hyperparameters}
    ...
    \begin{columns}
        ...
        \end{column}
        \begin{column}{0.42\textwidth}
            {\footnotesize \faIcon{flask} \textbf{Configs tested:} 34}\\
            {\scriptsize \quad 15 batch $\cdot$ 15 neighbor $\cdot$ 4 scaling}
        \end{column}
    \end{columns}
\end{frame}
